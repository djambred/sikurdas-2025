...
class LearningOutcomePolicy
{
    ...
    {
        return $user->can('view_any_learning::outcome');
    }
    ...
    {
        return $user->can('view_learning::outcome');
    }
    ...
    {
        return $user->can('create_learning::outcome');
    }
    ...
    {
        return $user->can('update_learning::outcome');
    }
    ...
    {
        return $user->can('delete_learning::outcome');
    }
    ...
    {
        return $user->can('delete_any_learning::outcome');
    }
