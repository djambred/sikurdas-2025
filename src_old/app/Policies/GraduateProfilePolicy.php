...
class GraduateProfilePolicy
{
    ...
    {
        return $user->can('view_any_graduate::profile');
    }
    ...
    {
        return $user->can('view_graduate::profile');
    }
    ...
    {
        return $user->can('create_graduate::profile');
    }
    ...
    {
        return $user->can('update_graduate::profile');
    }
    ...
    {
        return $user->can('delete_graduate::profile');
    }
    ...
    {
        return $user->can('delete_any_graduate::profile');
    }
     ...
     */
    public function replicate(User $user, GraduateProfile $graduateProfile): bool
    {
