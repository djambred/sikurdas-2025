...
class ReferencePolicy
{
    ...
    {
        return $user->can('view_any_reference');
    }
    ...
    {
        return $user->can('view_reference');
    }
    ...
    {
        return $user->can('create_reference');
    }
    ...
    {
        return $user->can('update_reference');
    }
    ...
    {
        return $user->can('delete_reference');
    }
    ...
    {
        return $user->can('delete_any_reference');
    }
     ...
     */
    public function replicate(User $user, Reference $reference): bool
    {
